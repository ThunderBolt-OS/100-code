...
/*
    ...
    * @Space Complexity: O(E) or O(V)
    * Worst case: O(ElogV) or O(ElogE)
    * Best case: O(ElogV) or O(ElogE)
    * Average case: O(ElogV) or O(ElogE)
    * @Note: This is a greedy algorithm
    * @Application: Applications are listed below  

*/

public class KruskalsMSP {
	...
	public static void main(String[] args)
	{
		...
		KruskalsMSP graph = new KruskalsMSP(V, E);
...
/* 
    ...
    * network design of telephone or electrical wires,
